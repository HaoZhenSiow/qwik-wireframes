...
export default component$(() => {
  ...
  return (
    <>
      ...
      <div class={`project`} onClick$={showDialog}>
        <div class="visual">
      ...
      {isShown && <dialog ref={dialogRef}>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque veniam expedita ducimus impedit accusantium. Earum, quae aperiam. Iste possimus impedit doloremque officia dolorem? Cupiditate expedita ab repellat non, saepe iure?</p>
      </dialog>}
    </>
  )
})